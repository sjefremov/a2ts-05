...
var IngredientsService = (function () {
    function IngredientsService(http) {
        this.http = http;
        this.baseUrl = "http://localhost:8083/ingredients/";
    }
    IngredientsService.prototype.getAll = function (page) {
        return this.http.get(this.baseUrl)
            .map(function (response) { return response.json(); });
    };
    IngredientsService.prototype.delete = function (id) {
        return this.http.delete(this.baseUrl + id);
    };
    IngredientsService.prototype.save = function (obj) {
